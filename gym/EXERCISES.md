...
| Cable Lat Pushdown          | `straight-arm-cable-pulldown`                                         | Normalized as a straight-arm cable pulldown; keep the setup consistent                | September 1 attachment and elbow position not recorded             |
...
| Two-Hand Cable Biceps Curl  | `cable-biceps-curl`                                                   | Bilateral cable-stack movement; keep the setup consistent                             | September 1 attachment and machine identity not recorded           |
...
| Cable Lateral Raise         | `cable-lateral-raise`                                                 | Can be per arm                                                                        | July 16 and August 3 are per arm; August 12 loading is unspecified |
| Cable Front Raise           | `cable-front-raise`                                                   | Can be per side                                                                       | Earlier sessions are per side; August 12 loading is unspecified    |
| Spider Curl                 | `spider-curl`                                                         | September 8 used 20 lb per dumbbell                                                   | Earlier equipment/per-hand status was not always recorded          |
| Incline Curl                | `incline-curl`                                                        | September 8 used 15 lb per dumbbell                                                   | Earlier equipment/per-hand status was not always recorded          |
...
| High Cable Chest Press      | `high-cable-chest-press`                                              | Preserve the entered stack load; record per-side status when known                    | September 7 cable setup/per-side status remains unknown            |
| Mid Cable Fly               | `mid-cable-fly`                                                       | Preserve the entered stack load; record per-side status when known                    | September 7 cable setup/per-side status remains unknown            |
...
| Smith-Machine Squat         | `smith-squat`                                                         | 25 lb Smith bar included; preserve the primary Smith-machine identity                 | September 3 back-pain response and RIR were not supplied           |
