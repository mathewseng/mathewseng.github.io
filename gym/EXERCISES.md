...
| Spider Curl                 | `spider-curl`                                                         | May use two dumbbells                                                                 | September 1 equipment and per-hand status were not restated        |
| Incline Curl                | `incline-curl`                                                        | May use two dumbbells                                                                 | September 1 equipment and per-hand status were not restated        |
...
| High Cable Chest Press      | `high-cable-chest-press`                                              | Preserve the entered stack load; record per-side status when known                    | August 3 and August 12 cable setup/per-side status are unknown     |
| Mid Cable Fly               | `mid-cable-fly`                                                       | Preserve the entered stack load; record per-side status when known                    | August 3 and August 12 cable setup/per-side status are unknown     |
