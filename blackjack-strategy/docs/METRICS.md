...
The chart applies integer true-count indexes. When the tracker is used, true count is `running count / decks remaining`, truncated toward zero. When the manual slider is used, that integer is applied directly.
